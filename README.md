...
Development platform for the **NXP DEVKIT-MPC5744P** board (MPC5744P / e200z4) using PlatformIO and the PowerPC EABI VLE toolchain. Firmware is compiled and linked against **EWL** (`ewl_c9x_noio.specs`: `-lc99 -lm -lrt`). Point `board_build.ewl_dir` in `platformio.ini` at the host `e200_ewl2` folder.
