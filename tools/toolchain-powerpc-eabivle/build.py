#!/usr/bin/env python3
"""
Build PlatformIO toolchain package from S32DS installer.
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        description="Build PlatformIO toolchain package from S32DS installer"
    )
    parser.add_argument(
        "installer_root",
        type=Path,
    ...
    try:
        # Build package
        extractor = ToolchainExtractor(args.installer_root, args.output)
        ...
        if args.update_package_json:
            ...
            if package_json.exists():
                # Load metadata
                metadata_path = args.output / "toolchain-powerpc-eabivle.metadata.json"
